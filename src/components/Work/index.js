      ...
      <div className="info">
        ...
        <section className="new-work1">
          <div className="work-photo">
              <a href="https://sheltered-cliffs-36049.herokuapp.com/" target="_blank" rel="noreferrer"> <div className="work4"></div></a>
          </div>
          <div className="work-text">
            ...
            <div className="click">
              <a href="https://github.com/gilinamcbride/travel-blog.git" target="_blank" rel="noreferrer">
                <button type="button" className="button">View Github Repository</button> </a></div>
          </div>
      </section>
      <div className="recent-work-nav">
        <div><a href="https://github.com/gilinamcbride" target="_blank" rel="noreferrer"
          >&larr; More Work On Github</a></div>
          <div><a className="work-btn" href="./work.html" target="_blank">View All Work &rarr;</a></div>
      </div>
    </main>
    )
}
